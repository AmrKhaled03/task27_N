...
const Movie = () => {
    ...
    useEffect(() => {
        fetch(`https://api.themoviedb.org/3/movie/${id}?api_key=a9a00ffebc7105f0a6a9cc68319b0f08`)
        .then(res => res.json())
    ...
    return (
        <div className="movie"  >
            <div className="movie__intro">
                <img className="movie__backdrop img-fluid" src={`https://image.tmdb.org/t/p/original${currentMovieDetail ? currentMovieDetail.backdrop_path : ""}`} alt="img" />
            </div>
            <div className="movie__detail">
                <div className="movie__detailLeft">
                    <div className="movie__posterBox">
                        <img className="movie__poster img-fluid" src={`https://image.tmdb.org/t/p/original${currentMovieDetail ? currentMovieDetail.poster_path : ""}`} alt="img"/>
                    </div>
                </div>
                <div className="movie__detailRight">
                    ...
                    <div className="movie__detailRightBottom">
                        <div className="synopsisText text-light">Synopsis</div>
            ...
            <div className="movie__links">
                <div className="movie__heading text-light">Useful Links</div>
                {
                        ...
                        <>
                            {
                                ...
                                <span className="productionCompanyImage" key={company.id}>
                                    <img className="movie__productionComapany img-fluid" src={"https://image.tmdb.org/t/p/original" + company.logo_path} alt="img" />
